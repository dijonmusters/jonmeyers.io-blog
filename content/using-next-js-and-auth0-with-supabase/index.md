...
![Screen Shot 2021-09-06 at 2.56.23 pm.png](./images/Screen_Shot_2021-09-06_at_2.56.23_pm.png)

Give your tenant a unique `Domain`, set the `Region` closest to you, and leave the `Environment Tag` set to `Developement`.

![Screen Shot 2021-09-06 at 2.58.04 pm.png](./images/Screen_Shot_2021-09-06_at_2.58.04_pm.png)
...
![Screen Shot 2021-09-06 at 3.07.25 pm.png](./images/Screen_Shot_2021-09-06_at_3.07.25_pm.png)
...
![Screen Shot 2021-09-06 at 9.14.20 pm.png](./images/Screen_Shot_2021-09-06_at_9.14.20_pm.png)
...
![Screen Shot 2021-09-06 at 9.14.49 pm.png](./images/Screen_Shot_2021-09-06_at_9.14.49_pm.png)
...
![Screen Shot 2021-09-06 at 9.25.39 pm.png](./images/Screen_Shot_2021-09-06_at_9.25.39_pm.png)

Create a `todo` table and add columns for `content`, `user_id` and `is_complete`.

![Screen Shot 2021-09-06 at 9.30.56 pm.png](./images/Screen_Shot_2021-09-06_at_9.30.56_pm.png)
...
![Screen Shot 2021-09-06 at 9.39.14 pm.png](./images/Screen_Shot_2021-09-06_at_9.39.14_pm.png)
...
![Screen Shot 2021-09-07 at 2.14.48 pm.png](./images/Screen_Shot_2021-09-07_at_2.14.48_pm.png)
...
![Screen Shot 2021-09-06 at 10.13.21 pm.png](./images/Screen_Shot_2021-09-06_at_10.13.21_pm.png)

Now if we refresh our application we will see the empty state message.

![Screen Shot 2021-09-06 at 10.19.28 pm.png](./images/Screen_Shot_2021-09-06_at_10.19.28_pm.png)
...
![Screen Shot 2021-09-08 at 4.18.17 pm.png](./images/Screen_Shot_2021-09-08_at_4.18.17_pm.png)
...
![Screen Shot 2021-09-08 at 4.19.34 pm.png](./images/Screen_Shot_2021-09-08_at_4.19.34_pm.png)
...
![Screen Shot 2021-09-08 at 4.18.53 pm.png](./images/Screen_Shot_2021-09-08_at_4.18.53_pm.png)
...
![Screen Shot 2021-09-07 at 1.53.20 pm.png](./images/Screen_Shot_2021-09-07_at_1.53.20_pm.png)
...
![Screen Shot 2021-09-06 at 10.19.28 pm.png](./images/Screen_Shot_2021-09-06_at_10.19.28_pm 1.png)

Nope!

But we are very close! If we look at the `Table editor` in the Supabase dashboard. Who is the user that owns the todos?

![Screen Shot 2021-09-07 at 2.43.23 pm.png](./images/Screen_Shot_2021-09-07_at_2.43.23_pm.png)
...
![Screen Shot 2021-09-07 at 2.46.24 pm.png](./images/Screen_Shot_2021-09-07_at_2.46.24_pm.png)

The `user_id` is displayed at the top of your user's details page.

![Screen Shot 2021-09-07 at 2.46.47 pm.png](./images/Screen_Shot_2021-09-07_at_2.46.47_pm.png)

Let's copy this value and paste it is as the `user_id` for the `todos`.

![Screen Shot 2021-09-07 at 2.49.53 pm (2).png](Using%20Next%20js%20and%20Auth0%20with%20Supabase%20cc1866684f314f459188a4eeb53e444b/Screen_Shot_2021-09-07_at_2.49.53_pm_(2).png)

Refresh our Next.js application!

Voilà! Todos!!!

![Screen Shot 2021-09-07 at 2.14.48 pm.png](./images/Screen_Shot_2021-09-07_at_2.14.48_pm 1.png)
